...
import com.hr.ui.R;
import com.hr.ui.activity.CreateResumeJobExpActivity;
import com.hr.ui.activity.CreateSelectPlaceToResumeActivity;
 ...
 * 新建简历 工作经验 Adapter
 */
public class CreateResumeJobExpLVAdapter extends BaseExpandableListAdapter {
    ...
    private CreateResumeJobExpActivity resumeJobContext;
    private static ItemViewHolder ivHolder;

    public CreateResumeJobExpLVAdapter(Context context, ArrayList<ResumeExperience> list, String resumeId, String resumeLanguage, CreateResumeJobExpActivity resumeJobContext) {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ivHolder.tv_resume_item_jobexp_workplace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, CreateSelectPlaceToResumeActivity.class);
...
//            ivHolder.tv_resume_item_jobexp_workplace.setText(list.get(groupPosition).getCompanyaddress());
    ...
    private void saveData(int position, ItemViewHolder ivHolder) {
        ...
        if (resumeExperience.getId() == -1) {// 新建后保存
            ...
            if (resultInsert > 0) {
                ...
                CreateResumeJobExpActivity.goneLinear();
    ...
    class ViewHolder {
        TextView tv_resume_item_time1, tv_resume_item_2, tv_resume_item_3, tv_resume_item_4, linear_resumejob_haveexpe;
    }

    class ItemViewHolder {
        TextView tv_resume_item_jobexp_starttime, tv_resume_item_jobexp_endtime, tv_resume_item_jobexp_workplace, tv_resume_item_jobexp_delete;
