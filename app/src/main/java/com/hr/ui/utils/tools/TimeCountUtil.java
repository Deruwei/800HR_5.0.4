...
/**
 * Created by Colin on 2016/12/12.
 * 倒计时
 */
...
//设置按钮为灰色，这时是不能点击的
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.linear_yuanhu_bg_hui));
    ...
    public void onFinish() {
        ...
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.linear_yuanhu_button));//还原背景色
    }
}
