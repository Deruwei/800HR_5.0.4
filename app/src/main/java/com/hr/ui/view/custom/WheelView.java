...
import com.hr.ui.adapter.WheelAdapter;
import com.hr.ui.listen.OnWheelChangedListener;
import com.hr.ui.listen.OnWheelScrollListener;
...
public class WheelView extends View {
    ...
    static int height = Math.round(SubscriptionActivity.display.heightPixels / 15);
    /**
     * 锟斤拷时锟斤拷
     */
     ...
     * 锟斤拷前值&锟斤拷签锟侥憋拷锟斤拷色
     */
    private static final int VALUE_TEXT_COLOR = 0x88888888;

    /**
     * 锟斤拷锟侥憋拷锟斤拷色
     */
    private static final int ITEMS_TEXT_COLOR = 0x88888888;

    /**
     * 锟斤拷锟斤拷锟酵底诧拷锟斤拷锟斤拷影锟斤拷色
     */
    private static final int[] SHADOWS_COLORS = new int[]{0x00000000,
            0x00000000, 0x00000000};

    /**
     * 锟斤拷锟斤拷锟斤拷锟狡凤拷叨锟?锟斤拷拥锟斤拷锟阶硷拷谋锟斤拷锟竭讹拷)
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = height;
    ...
    /**
     * 锟斤拷锟斤拷锟酵底诧拷锟斤拷目锟斤拷锟斤拷(锟斤拷锟斤拷))
     */
    private final int ITEM_OFFSET = TEXT_SIZE / 1;

    /**
     * 锟斤拷锟斤拷目锟斤拷锟斤拷目锟斤拷锟斤拷
     */
     ...
     * the last one
     * 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟窖拷锟斤拷锟斤拷锟斤拷锟轿讹拷锟斤拷诘锟揭伙拷锟斤拷锟斤拷锟绞撅拷锟斤拷一锟斤拷
     *
    ...
    private int getItemHeight() {
        if (itemHeight != 0) {
            return itemHeight;
        } else if (itemsLayout != null && itemsLayout.getLineCount() > 1) {
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        itemsWidth += ADDITIONAL_ITEMS_SPACE; // make it some more锟矫革拷锟斤拷
