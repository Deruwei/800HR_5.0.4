            ...
            functionselect_listview
                    .setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                            // 一级实例
                            CreateSelectFunctionJobOrderActivity functionSelectActivity1 = CreateSelectFunctionJobOrderActivity.this;
...
//                                }
                                ...
                                try {
                                    ...
                                    adapter2 = new MyBaseAdapterFindJobFunctionSelect2(CreateSelectFunctionJobOrderActivity.this, dataList2, index, selectMap);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_selectfunction_save:
                // 设置搜索页信息
                CreateResumeJobOrderActivity.getInstance().setFunctionSelected(selectMap);
                selectMap.clear();
                finish();
                break;
