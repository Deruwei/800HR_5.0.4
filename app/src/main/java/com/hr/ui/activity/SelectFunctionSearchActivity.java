            ...
            functionselect_listview
                    .setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                            // 一级实例
                            SelectFunctionSearchActivity functionSelectActivity1 = SelectFunctionSearchActivity.this;
...
//                                    selectMap.clear();
//                                    clearView();
//                                    selectMap.put(dataItem.get("key"), dataItem.get("value"));
//                                    addView(dataItem.get("key"), dataItem.get("value"));
//                                }
                                ...
                                try {
                                    ...
                                    adapter2 = new MyBaseAdapterFindJobFunctionSelect2(SelectFunctionSearchActivity.this, dataList2, index, selectMap);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_selectfunction_save:
                // 设置搜索页信息
                PagerPostSearchFragment.setFunctionSelectMap(selectMap);
                selectMap.clear();
                finish();
                break;
