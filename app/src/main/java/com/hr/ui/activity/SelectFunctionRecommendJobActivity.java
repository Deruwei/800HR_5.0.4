...
public class SelectFunctionRecommendJobActivity extends BaseActivity implements OnClickListener {
    ...
    private void init() {
        try {
            ...
            funtionselect_selectedinfo.setText(selectMap.size() + "/5");//最多只能选5像
...
//                                }
                                ...
                                try {
                                    ...
                                    adapter2 = new MyBaseAdapterFindJobFunctionSelect2(SelectFunctionRecommendJobActivity.this, dataList2, index, selectMap);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_selectfunction_save:
                // 设置搜索页信息
                RecommendJobFragment.setFunctionSelectMap(selectMap);
                selectMap.clear();
                finish();
                break;
