 ...
 * 职能选择（可多选）
 */
public class SelectFunctionJobOrderActivity extends BaseActivity implements OnClickListener {
            ...
            functionselect_listview
                    .setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                            // 一级实例
                            SelectFunctionJobOrderActivity functionSelectActivity1 = SelectFunctionJobOrderActivity.this;
...
//                                }
                                ...
                                try {
                                    ...
                                    adapter2 = new MyBaseAdapterFindJobFunctionSelect2(SelectFunctionJobOrderActivity.this, dataList2, index, selectMap);
    ...
    private void removeView(String tagString,
                            SelectFunctionJobOrderActivity functionSelectActivity) {
    ...
    private boolean checkSelected() {
        if (selectMap.size() == 5) {
            Toast.makeText(SelectFunctionJobOrderActivity.this, "最多选择5个职位",
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_selectfunction_save:
                // 设置搜索页信息
                ResumeJobOrderActivity.getInstance().setFunctionSelected(selectMap);
                selectMap.clear();
                finish();
                break;
